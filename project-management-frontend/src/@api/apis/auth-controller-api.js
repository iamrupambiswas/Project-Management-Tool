...
import { AuthRequestDtoToJSON, AuthResponseDtoFromJSON, RegisterRequestDtoToJSON, } from '../models/index';
/**
 *
 */
export class AuthControllerApi extends runtime.BaseAPI {
    ...
    async loginRaw(requestParameters, initOverrides) {
        if (requestParameters['authRequestDto'] == null) {
            throw new runtime.RequiredError('authRequestDto', 'Required parameter "authRequestDto" was null or undefined when calling login().');
        }
    ...
    async registerRaw(requestParameters, initOverrides) {
        if (requestParameters['registerRequestDto'] == null) {
            throw new runtime.RequiredError('registerRequestDto', 'Required parameter "registerRequestDto" was null or undefined when calling register().');
        }
        const queryParameters = {};
        const headerParameters = {};
        headerParameters['Content-Type'] = 'application/json';
