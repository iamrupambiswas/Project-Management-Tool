import { Bell, LayoutDashboard, Users, User, Folder, ListChecks } from "lucide-react";
...
// Use regex-based path matchers to dynamically match URLs
const routeMaps: {
  path: RegExp;
  title: string;
  Icon: LucideIcon;
}[] = [
  // Dynamic Routes (placed first)
  { path: /^\/projects\/\d+$/, title: "Project Details", Icon: Folder },
  { path: /^\/tasks\/\d+$/, title: "Task Details", Icon: ListChecks },
  { path: /^\/teams\/\d+$/, title: "Team Details", Icon: Users }, // ✅ Added Team Details
